...
public class CustomRadioGroup extends LinearLayout {
    ...
    public CustomRadioGroup(Context context, AttributeSet attrs) {
        ...
        final int index = attributes.getInt(Resources.getSystem().getIdentifier("RadioGroup_orientation", "styleable", "android"), HORIZONTAL);
    ...
    public interface OnCheckedChangeListener {
        public void onCheckedChanged(CustomRadioGroup group, @IdRes int checkedId);
    }
